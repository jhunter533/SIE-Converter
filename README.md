...
This program will try to sanitize filenames just in case allow several command line arguments such as a custom output directory which does not need to be precreated. The program outputs each channel as a separate file for organization reasons though I may change that in the future.
